...
.isdeploying   -- Placed by the deployment scanner ui to indicate that it
...
.deployed      -- Placed by the deployment scanner ui to indicate that the
                  given content has been deployed into the runtime. If an end
                  user deletes this file, the content will be undeployed.

.failed        -- Placed by the deployment scanner ui to indicate that the
...
.isundeploying -- Placed by the deployment scanner ui to indicate that it
...
.undeployed    -- Placed by the deployment scanner ui to indicate that the
                  given content has been undeployed from the runtime. If an end
                  user deletes this file, it has no impact.

.pending       -- Placed by the deployment scanner ui to indicate that it
